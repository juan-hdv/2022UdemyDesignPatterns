...
class Creature(ABC):
    ...
    def calculate_powers(self): pass
...
class Goblin (Creature):
    ...
    def calculate_powers(self):
        size = len(self.game.creatures)
        for c in self.game.creatures:
            c.defense = c.initial_defense + size - 1
...
class GoblinKing(Goblin):
    ...
    def calculate_powers(self):
        ...
        super().calculate_powers()
        # !!! I don't understand why this is not done in the __init_ chain ??

        for c in self.game.creatures:
            c.attack = c.initial_attack + 1
